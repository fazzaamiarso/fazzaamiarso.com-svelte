...
<div class="h-container">
	<div class="h-panel ring-brand-700 flex flex-col gap-8 lg:gap-16 py-20 lg:grid lg:grid-cols-3 lg:items-center">
		<figure class="">
			<img src={scratch} alt="scratch logo" class="w-60 mx-auto" />
			<figcaption class="text-center italic text-gray-700">scratch that I learned</figcaption>
		</figure>
	...
	<div class="h-panel ring-brand-700 flex flex-col gap-8 lg:gap-16 py-20 lg:grid lg:grid-cols-3 lg:items-center">
		<figure class="">
			<img src={team} alt="my robotic team in high school" class="w-96 mx-auto rounded-md" />
			<figcaption class="text-center italic text-gray-700">My robotic team and teachers in high school</figcaption>
		</figure>
		<p class="col-span-2 text-body-lg md:text-body-xl w-full">
